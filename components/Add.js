...
export default function Add() {
    ...
    db.transaction((tx) => {
        tx.executeSql(
            'create table if not exists preguntas (id integer primary key autoincrement, pergunta text, alternativaA texte, alternativaB text, alternativaC text, alternativaD text, resposta_correta text);'
        )
    })
